<div class="px-4">
    <x-feature feature-title="Get guided through setup" y-position="top" img-src="/images/version-manager.jpg?v=2025.11">
        PHP Monitor helps you get from a fresh macOS installation to a machine for PHP development. It can <b>guide you through the entire setup flow</b>, without making you piece together terminal commands by hand.
    </x-feature>
    <x-feature feature-title="A GUI for managing PHP versions" img-src="/images/version-manager.jpg?v=2025.11" y-position="top" class="lg:flex-row-reverse">
    ...
    <x-feature feature-title="Easily manage PHP extensions" img-src="/images/extensions.jpg?v=2025.11" y-position="top">
    ...
    <x-feature feature-title="Quickly link a new domain or proxy" img-src="/images/link-folder.jpg?v=2025.11" y-position="top" class="lg:flex-row-reverse">
    ...
    <x-feature feature-title="All of your domains in a single list" img-src="/images/domains.jpg?v=2025.11" y-position="top">
    ...
    <x-feature feature-title="Small, frequent, fast and easy updates" img-src="/images/updater.jpg?v=2025.11" y-position="bottom" class="lg:flex-row-reverse">
    ...
    <x-feature feature-title="Totally free & open source" y-position="top" x-position="left" img-src="/images/oss.png?v=7">
